...
/subsystem=elytron/security-domain=jwt-domain:add(realms=[{realm=JWT_REALM,role-decoder=groups-to-roles}],permission-mapper=default-permission-mapper,default-realm=jwt-realm)
