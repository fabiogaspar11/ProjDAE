...
public class ConfigBean {
    ...
    public void populateDB() throws MyEntityExistsException, MyEntityNotFoundException {
        ...
        patientBean.create("carlamendes12","Carla Mendes","2191111@my.ipleiria.pt","12345","05/06/1999","916345345",978675432,(float)55.5,(float)1.60);
        patientBean.create("carloscosta13","Carlos Costa","2191131@my.ipleiria.pt","12345","11/04/1984","912343274",987654321,(float)70.2,(float)1.80);
